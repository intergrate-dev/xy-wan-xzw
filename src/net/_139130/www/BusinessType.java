...
public class BusinessType  implements java.io.Serializable {
    ...
    private net._139130.www.BindChannel[] bindChs;
    ...
    public BusinessType(
           ...
           boolean extendFlag,
           int state,
           net._139130.www.BindChannel[] bindChs) {
           this.id = id;
           this.name = name;
     ...
     * @return bindChs
     */
    public net._139130.www.BindChannel[] getBindChs() {
        return bindChs;
    }
     ...
     * @param bindChs
     */
    public void setBindChs(net._139130.www.BindChannel[] bindChs) {
        this.bindChs = bindChs;
    }
