...
public class MTPacks  implements java.io.Serializable {
    ...
    private net._139130.www.MediaItems[] medias;

    private net._139130.www.MessageData[] msgs;
    ...
    public MTPacks(
           ...
           int sendType,
           int msgType,
           net._139130.www.MediaItems[] medias,
           net._139130.www.MessageData[] msgs,
           int bizType,
     ...
     * @return medias
     */
    public net._139130.www.MediaItems[] getMedias() {
        return medias;
    }
     ...
     * @param medias
     */
    public void setMedias(net._139130.www.MediaItems[] medias) {
        this.medias = medias;
    }
     ...
     * @return msgs
     */
    public net._139130.www.MessageData[] getMsgs() {
        return msgs;
    }
     ...
     * @param msgs
     */
    public void setMsgs(net._139130.www.MessageData[] msgs) {
        this.msgs = msgs;
    }
